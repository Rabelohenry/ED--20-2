/*
    ...
    Solução de: Henrique Silva Rabelo
*/
#include <iostream>
#include <algorithm>
...
public:
    ...
    ~biblioteca();
    biblioteca(const biblioteca &meubiblioteca);
...
biblioteca::biblioteca(const biblioteca &meubiblioteca)
{
    livro *listaNovaDeLivros;
    listaNovaDeLivros = new livro[quantidadeDeItens];

    copy(meubiblioteca.listaDeLivros, meubiblioteca.listaDeLivros + meubiblioteca.quantidadeDeItens, listaNovaDeLivros);

    quantidadeDeItens = meubiblioteca.quantidadeDeItens;
    capacidadeMaxima = meubiblioteca.capacidadeMaxima;
}
...
{
    livro *listaNovaDeLivros;
    listaNovaDeLivros = new livro[quantidadeDeItens + 4];

    copy(listaDeLivros, listaDeLivros + capacidadeMaxima, listaNovaDeLivros);

    delete[] listaDeLivros;

    listaDeLivros = listaNovaDeLivros;

    capacidadeMaxima = quantidadeDeItens + 4;
}
...
int main()
{
    ...
    while (opcaoDoMenu != 's')
    {
        ...
        case 'i':
            ...
            cin >> umlivro.nomeDoProduto >> umlivro.quantidadeEmEmprestimo >> umlivro.quantidadeDeExemplares;
        ...
        case 'b':
            ...
            if (meubiblioteca.buscarlivro(nome, umlivro))
                cout << umlivro.nomeDoProduto << " "
                     ...
                     << umlivro.quantidadeDeExemplares << endl
                     << endl;
            else
